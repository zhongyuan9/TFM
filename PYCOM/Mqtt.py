...
# Wireless network
WIFI_SSID = "DIGIFIBRA-NXAP"
WIFI_PASS = "P9P6tzQbbT" # No this is not our regular password. :)

# Adafruit IO (AIO) configuration
AIO_SERVER = "io.adafruit.com"
AIO_PORT = 1883
AIO_USER = "xiaohangge"
AIO_KEY = "aio_dgEY92iAbuJrH5gl22PbpdwbDVNu"
AIO_CLIENT_ID = ubinascii.hexlify(machine.unique_id())  # Can be anything
AIO_CONTROL_FEED = "xiaohangge/feeds/lights"
AIO_RANDOMS_FEED = "xiaohangge/feeds/randoms"
...
def sub_cb(topic, msg):          # sub_cb means "callback subroutine"
    ...
    if msg == b"ON":             # If message says "ON" ...
        pycom.rgbled(0xFF00FF)   # ... then LED on
    ...
    some_number = wendu
    print("Sending data:  ".format(some_number, AIO_RANDOMS_FEED), end='')
    try:
